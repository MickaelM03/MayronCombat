...
export const CHARACTERS = [
  ...
  { id: 'clara', name: 'Clara', faction: 'Family', img: '/images/clara_sf_1778869274381.png', color: 'from-purple-500 to-fuchsia-700', voice: 'Despina', voiceStyle: 'ado_fille' },
  { id: 'mayron', name: 'Mayron', faction: 'Family', img: '/images/mayron_sf_1778869286648.png', color: 'from-cyan-500 to-blue-700', voice: 'Puck', voiceStyle: 'ado_garcon' },
  ...
  { id: 'haru', name: 'Haru l\'éclair', faction: 'Course', img: '/images/haru_sf_1778869297582.png', color: 'from-red-500 to-red-700', voice: 'Puck', voiceStyle: 'hero_jeune' },
  { id: 'bizzcotte', name: 'Bizzcotte', faction: 'Abeille', img: '/images/bizzcotte_sf_1778869311196.png', color: 'from-yellow-400 to-black', voice: 'Kore', voiceStyle: 'aventuriere' },
  { id: 'bizzou', name: 'Bizzou', faction: 'Abeille', img: '/images/bizzou_sf_1778869331542.png', color: 'from-yellow-500 to-orange-600', voice: 'Leda', voiceStyle: 'enfant_diabolique' },
  { id: 'zoe', name: 'Zoé la souris', faction: 'Détective', img: '/images/zoe_sf_1778869351673.png', color: 'from-gray-400 to-pink-200', voice: 'Zephyr', voiceStyle: 'enfant' },
  { id: 'jeppy', name: 'Jeppy l\'Ours', faction: 'Détective', img: '/images/jeppy_sf_1778869368351.png', color: 'from-brown-600 to-orange-800', voice: 'Enceladus', voiceStyle: 'ogre' },
  { id: 'nouky', name: 'Nouky le raton', faction: 'Détective', img: '/images/nouky_sf_1778869380752.png', color: 'from-slate-500 to-black', voice: 'Puck', voiceStyle: 'gangster' },
  { id: 'aivy', name: 'Aïvy', faction: 'Montagne', img: '/images/aivy_sf_1778869417938.png', color: 'from-emerald-500 to-green-700', voice: 'Leda', voiceStyle: 'aventuriere' },
  { id: 'will', name: 'Will la débrouille', faction: 'Montagne', img: '/images/will_sf_1778869430503.png', color: 'from-blue-600 to-indigo-800', voice: 'Umbriel', voiceStyle: 'gamer' },
  { id: 'lilon', name: 'Lilon l\'elfe', faction: 'Magie', img: '/images/lilon_sf_1778869443716.png', color: 'from-cyan-300 to-blue-500', voice: 'Zephyr', voiceStyle: 'hero_jeune' },
  { id: 'camille', name: 'Camille l\'ensorceleuse', faction: 'Magie', img: '/images/camille_sf_1778869456675.png', color: 'from-purple-600 to-black', voice: 'Aoede', voiceStyle: 'monotone' },
  { id: 'lucien', name: 'Lucien le pyromancien', faction: 'Magie', img: '/images/lucien_sf_1778869479968.png', color: 'from-red-600 to-orange-500', voice: 'Fenrir', voiceStyle: 'guerrier' },
  { id: 'sam_matou', name: 'Sam le matou', faction: 'Théâtre', img: '/images/sam_matou_sf_1778869491600.png', color: 'from-orange-400 to-amber-600', voice: 'Zephyr', voiceStyle: 'enfant' },
  { id: 'pattie', name: 'Pattie', faction: 'Théâtre', img: '/images/pattie_sf_1778869506126.png', color: 'from-pink-400 to-rose-600', voice: 'Kore', voiceStyle: 'aventuriere' },
...
export const ARENAS = [
  { id: 'living_room', name: 'Le Salon de la Maison', img: '/images/arena_living_room_1778914685868.png' },
  { id: 'springfield', name: 'Springfield Centrale', img: '/images/arena_springfield_1778914700052.png' },
  { id: 'los_santos', name: 'Rues de Los Santos', img: '/images/arena_los_santos_1778914714921.png' },
  { id: 'nether', name: 'Le Nether', img: '/images/arena_nether_1778914728853.png' },
  { id: 'pmu', name: 'Le PMU du Coin', img: '/images/pmu_du_coin_sf_1778416966206.png' },
  { id: 'parking', name: 'Parking du Supermarché', img: '/images/arena_parking_1778914759140.png' },
  { id: 'caf', name: 'File d\'Attente de la CAF', img: '/images/arena_caf_1778914774222.png' },
  { id: 'space', name: 'Station Spatiale Alpha', img: '/images/arena_space_station_1778914792444.png' },
  { id: 'cyberpunk', name: 'Neo-Tokyo 2077', img: '/images/neotokyo_sf.png' },
  { id: 'hogwarts', name: 'Poudlard', img: '/images/hogwarts_sf.png' },
  { id: 'colosseum', name: 'Colisée de Rome', img: '/images/arena_colosseum_rome_1778914808284.png' },
  { id: 'forest', name: 'Forêt Mystique', img: '/images/arena_mystic_forest_1778914838577.png' },
  { id: 'beach', name: 'Plage de Copacabana', img: '/images/arena_copacabana_beach_1778914851944.png' },
  ...
  { id: 'vallee_ocre', name: 'Vallée de Terre Ocre', img: '/images/arena_vallee_ocre_1778914867065.png' },
  { id: 'circuit_casse_tout', name: 'Circuit Grand Prix', img: '/images/arena_grand_prix_circuit_1778914879862.png' },
  { id: 'ruche_champ_fleuri', name: 'Ruche de Champ-Fleuri', img: '/images/arena_ruche_champ_fleuri_1778914910282.png' },
  ...
  { id: 'jungle_ruines', name: 'Ruines de la Jungle', img: '/images/arena_jungle_ruins_1778914925955.png' },
  { id: 'chateau_ptit_bouh', name: 'Le Château Hanté', img: '/images/arena_haunted_castle_1778914943103.png' },
  { id: 'montagne_dahu', name: 'Sommets Enneigés', img: '/images/arena_snowy_summits_sf.png', description: 'Le sommet du monde sous un blizzard éternel.' },
  { id: 'marseille', name: 'La Canebière', img: '/images/arena_marseille_canebiere_sf.png', description: 'Le cœur battant de Marseille, entre le Vieux-Port et l\'agitation urbaine.' },
];
